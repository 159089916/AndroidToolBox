...
/**
 * Created by Sikang on 2017/12/1.
 */
...
public class RelativeTabGroup extends RelativeLayout implements TabGroup {
    ...
    public RelativeTabGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RelativeTabGroup);
        maxSelected = array.getInt(R.styleable.RelativeTabGroup_maxSelect, 1);
        if (maxSelected < 1)
            maxSelected = 1;
        array.recycle();
        init();
    ...
    public RelativeTabGroup(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
